  ...
  const info = [
    {
      ...
      body: [
        {
          title: 'Приложение > Настройки > Поиск',
          text: '    По нажатию клавиши Enter выбирает первый элемент.',
        },
        {
          title: 'Приложение > Настройки > Список',
          text: '    Исправлен баг при выборе пустого элемента',
        },
      ],
    },
    {
      ...
      body: [
        {
          title: 'Приложение > Список заявок > Поиск',
          text:
            '    Добавлены параметры поиска:' +
            '\n    1) Телефон - поиск по номеру телефона инициатора инцидента;' +
            '\n    2) Электронная почта - поиск по электронной почте инициатора инцидента;',
        },
        {
          title: 'Приложение > Список заявок > Сортировка',
          text: '    Исправлена ошибка с первоначальной сортировкой списка заявок.',
        },
        {
          title: 'Приложение > Заявка > Описание ',
          text: '    Исправлено отображение выбранных в заявке ресурсов.',
        },
        {
          title: 'Архитектура > API ',
          text:
            '    Исправлена ошибка метода "comments". Комментарии оставляются, приложение обновляется.',
        },
      ],
    },
    {
      ...
      body: [
        {
          ...
          text:
            'Если создается заявка с участием любого из ресурсов, то требуется согласование владельца ресурса',
        },
        {
          title: 'НОВОЕ: Поиск',
          text:
      ...
      body: [
        {
          title: 'Архитектура',
          text:
            'Большая реконструкция кода. Сокращены объемы кода на 20%, и увеличена производительность.',
        },
        {
          title: 'Приложение > Меню',
          text:
            'Добавлены подсказки для пользователей. Подсказка показывается при наведении на кнопку.',
        },
      ],
    },
    {
